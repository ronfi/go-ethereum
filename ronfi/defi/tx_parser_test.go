...
func TestInfo_GetArbTxProfit(t *testing.T) {
	...
	tx, _, err := client.TransactionByHash(context.Background(), common.HexToHash("0xf2162a71f51b002631cd53a9e58d8e071a4f6a6ae97184d457e98547b8ad0928"))
	if err != nil {
		t.Fatal("TestInfo_GetArbTxProfit TransactionByHash failed!", "err", err)
	}

	receipt, err := client.TransactionReceipt(context.Background(), common.HexToHash("0xf2162a71f51b002631cd53a9e58d8e071a4f6a6ae97184d457e98547b8ad0928"))
	if err != nil {
...
func TestInfo_CheckIfObs(t *testing.T) {
	...
	tx, _, err := client.TransactionByHash(context.Background(), common.HexToHash("0x59f0dd5939a2682bd0664610c9693d5fd0ea33bc06f5adbc76d7081dfe9c7bde"))
	if err != nil {
		t.Fatal("TestInfo_CheckIfObs TransactionByHash failed!", "err", err)
	}

	receipt, err := client.TransactionReceipt(context.Background(), common.HexToHash("0x59f0dd5939a2682bd0664610c9693d5fd0ea33bc06f5adbc76d7081dfe9c7bde"))
	if err != nil {
